...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { api_link: @artwork.api_link, art_id: @artwork.art_id, artist_title: @artwork.artist_title, artwork_type_title: @artwork.artwork_type_title, classification_title: @artwork.classification_title, date_display: @artwork.date_display, department_title: @artwork.department_title, dimensions: @artwork.dimensions, gallery_title: @artwork.gallery_title, image_id: @artwork.image_id, image_link: @artwork.image_link, latitude: @artwork.latitude, longitude: @artwork.longitude, medium_display: @artwork.medium_display, place_of_origin: @artwork.place_of_origin, style_title: @artwork.style_title, title: @artwork.title } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { api_link: @artwork.api_link, art_id: @artwork.art_id, artist_title: @artwork.artist_title, artwork_type_title: @artwork.artwork_type_title, classification_title: @artwork.classification_title, date_display: @artwork.date_display, department_title: @artwork.department_title, dimensions: @artwork.dimensions, gallery_title: @artwork.gallery_title, image_id: @artwork.image_id, image_link: @artwork.image_link, latitude: @artwork.latitude, longitude: @artwork.longitude, medium_display: @artwork.medium_display, place_of_origin: @artwork.place_of_origin, style_title: @artwork.style_title, title: @artwork.title } }
